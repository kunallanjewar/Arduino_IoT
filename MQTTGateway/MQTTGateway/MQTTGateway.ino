...
IPAddress TCP_IP ( 10, 224, 172, 111 );				// Configure your static ip-address here
byte TCP_MAC[] = { 0x02, 0x5D, 0x6C, 0xE8, 0x8D, 0xB2 };	// Mac-address - You should change this! see note *2 above!
